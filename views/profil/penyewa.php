  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL; ?>/home/ubah/<?= $data['penyewa']['nik']; ?>" method="post">
          <div class="mb-3">
          ...
          <select class="form-select" aria-label="Default select example" name="jeniskelamin" value="<?= $data['penyewa']['jeniskelamin']; ?>">
